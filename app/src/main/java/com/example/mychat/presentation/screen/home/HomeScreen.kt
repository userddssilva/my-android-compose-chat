...
import com.example.mychat.presentation.component.ChatView
import com.example.mychat.presentation.component.ErrorView
import com.example.mychat.presentation.component.LoadingView
                    ...
                    LazyColumn(
                        ...
                        items(
                            ...
                            val unreadMessages by remember {
                                derivedStateOf {
                                    runCatching {
                                        val id = ParseUser.getCurrentUser().objectId
                                        room.lastSeenMessages[id] != room.messages.last().objectId
                                    }
                                        .getOrDefault(false)
                                }
                            }
